...
(function( undefined ) {
    ...
    Backbone.Model.prototype.addApiKey = function(baseUrl) {
	if (this.collection.username && this.collection.apikey) {
	    return baseUrl + "?username=" + this.collection.username + "&api_key=" + this.collection.apikey;
	}
